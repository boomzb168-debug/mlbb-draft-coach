...
heroAbilities = {
    "Benedetta": (
        "มีความสามารถในการพุ่งโจมตีและใช้สกิลติดตัวฟันด้วยความรวดเร็ว"
        " พร้อมทั้งมีสกิลกางโล่ต้านทานสถานะควบคุมและความเสียหายทั้งหมดได้"
    ),
    "Balmond": (
        "มีความสามารถในการหมุนตัวสร้างความเสียหายวงกว้างอย่างต่อเนื่อง"
        " พร้อมฟื้นฟูพลังชีวิตเมื่อจัดการเป้าหมายได้"
    ),
    "Minsitthar": (
        "มีความสามารถในการดึง ล็อคเป้าหมาย"
        " และยกเลิกสกิลพุ่งตัวของฮีโร่สายไฟต์เตอร์/แอสซาซิน"
    ),
    "Faramis": (
        "มีความสามารถในการสร้างโล่ชุบชีวิตเพื่อนร่วมทีมและทำดาเมจวงกว้าง"
    ),
    "Edith": (
        "มีความสามารถในการสลับร่างเป็นแทงค์รับดาเมจและเปลี่ยนเป็นมาร์คแมนยิงไกลเพื่อทำดาเมจปิดเกม"
    ),
    "Natan": (
        "มีความสามารถในการสร้างดาเมจเวทแบบรัวๆ"
        " และโจมตีระยะไกลทะลุเกราะป้องกัน"
    ),
    "Popol and Kupa": (
        "มีความสามารถในการเรียกหมาป่าช่วยโจมตี สตันศัตรู และเปิดวิสัยทัศน์แผนที่"
    ),
    "Alucard": (
        "มีความสามารถในการดูดเลือดสูง ไล่ล่าศัตรูได้อย่างรวดเร็ว"
        " และสร้างดาเมจต่อเนื่อง"
    ),
    "Sun": (
        "มีความสามารถในการสร้างแยกร่างเพื่อป่วนแนวหลัง ดันป้อมเร็ว และรุมศัตรู"
    ),
    "Lukas": (
        "มีความสามารถในการพุ่งเข้าประชิดตัวและสร้างคอมโบสกิลที่รุนแรงเพื่อกดดันเลน"
    ),
    "Phoveus": (
        "มีความสามารถในการกดใช้งานอัลติเมทได้รัวๆ"
        " เมื่อศัตรูมีการพุ่งตัว เหมาะสำหรับแก้ทางฮีโร่พุ่งเยอะ"
    ),
    "Aldous": (
        "มีความสามารถในการเก็บสะสมแต้มสแตก"
        " ทำให้การโจมตีรุนแรงถึงตายได้ในช่วงท้ายเกม"
    ),
    "Esmeralda": (
        "มีความสามารถในการดูดโล่ของศัตรูมาเป็นเกราะป้องกันให้ตนเองและมีความคล่องตัวสูง"
    ),
    "Cyclops": (
        "มีความสามารถในการล็อคเป้าหมายด้วยอัลติเมทและปล่อยลูกบอลเวทโจมตีได้อย่างต่อเนื่อง"
    ),
    "Beatrix": (
        "มีความสามารถในการเปลี่ยนอาวุธปืนได้หลากหลายรูปแบบเพื่อรับมือกับสถานการณ์ต่างๆ"
    ),
    "Khufra": (
        "มีความสามารถในการแปลงร่างเป็นลูกบอลเพื่อหยุดสกิลพุ่งตัวของศัตรูและควบคุมหมู่"
    ),
    "Marcel": (
        "มีความสามารถในการสนับสนุนเพื่อนร่วมทีมและสร้างสถานการณ์พลิกแพลงในไฟต์"
    ),
    "Granger": (
        "มีความสามารถในการยิงกระสุนเบิสต์ดาเมจระยะไกลด้วยปืนคู่ได้อย่างรวดเร็วและรุนแรง"
    ),
    "Joy": (
        "มีความสามารถในการแดชเคลื่อนที่ตามจังหวะดนตรีพร้อมสร้างความเสียหายเวทอย่างต่อเนื่อง"
    ),
    "Wanwan": (
        "มีความสามารถในการกระโดดหลบสกิลและปลดอัลติเมทเพื่อโจมตีศัตรูอย่างรวดเร็ว"
    ),
    "Obsidia": (
        "มีความสามารถในการโจมตีระยะไกลและสร้างดาเมจกดดันเลนได้อย่างยอดเยี่ยม"
    ),
    ...
    "Brody": (
        "มีความสามารถในการสะสมสแตกหมัดและปล่อยดาเมจระเบิดที่รุนแรงต่อเป้าหมาย"
    ),
    "Barats": (
        "มีความสามารถในการสะสมพลังเพิ่มขนาดตัวและกลืนกินศัตรูเพื่อแยกออกจากไฟต์"
    ),
    "Gloo": "มีความสามารถในการเกาะติดร่างศัตรูเพื่อปั่นป่วนและควบคุมทิศทาง",
    "Atlas": (
        "มีความสามารถในการดึงและกระชากศัตรูจำนวนมากเข้ามารวมกันเพื่อเปิดไฟต์"
    ),
    "Diggie": (
        "มีความสามารถในการแก้สถานะควบคุมทั้งหมด (CC)"
        " ให้กับเพื่อนร่วมทีมด้วยอัลติเมท"
    ),
    "Masha": (
        "มีความสามารถในการเพิ่มความเร็วโจมตีและมีหลอดเลือดถึง 3 หลอดทำให้ตื๊ดมาก"
    ),
    "Lolita": (
        "มีความสามารถในการกางโล่สะท้อนกระสุนและการันตีการสตันหมู่ด้วยค้อนยักษ์"
    ),
    "Lesley": (
        "มีความสามารถในการตอดเลือดระยะไกลด้วยคริติคอลและความสามารถในการอำพรางตัว"
    ),
    "Estes": (
        "มีความสามารถในการฟื้นฟูพลังชีวิตหมู่ให้กับเพื่อนร่วมทีมอย่างมหาศาล"
    ),
    "Karina": (
        "มีความสามารถในการรีเซ็ตคูลดาวน์สกิลเมื่อสังหารได้และสะท้อนการโจมตีปกติ"
    ),
    "Aamon": (
        "มีความสามารถในการหายตัวและรวบรวมเศษชิ้นส่วนเพื่อทำดาเมจเบิสต์ใส่ศัตรู"
    ),
    "Layla": "มีความสามารถในการโจมตีระยะไกลยิ่งไกลยิ่งแรง",
    "Clint": (
        "มีความสามารถในการยิงสกิลสลับกับการโจมตีปกติเพื่อสร้างดาเมจบีสท์คริติคอล"
    ),
    "Fanny": (
        "มีความสามารถในการโหนสลิงไปทั่วแผนที่เพื่อเข้าหาและสังหารศัตรูอย่างรวดเร็ว"
    ),
    "Mathilda": (
        "มีความสามารถในการสร้างโล่และพาเพื่อนร่วมทีมบินหนีหรือพุ่งเข้าหาศัตรู"
    ),
    "Alice": "มีความสามารถในการดูดเลือดรอบตัวและเทเลพอร์ตสร้างดาเมจเวทหมู่",
    "Hanabi": (
        "มีความสามารถในการเด้งการโจมตีใส่ศัตรูหลายตัวและมีเกราะต้านสถานะ"
    ),
    ...
    "Karrie": (
        "มีความสามารถในการโจมตีเจาะเกราะตามสัดส่วนเลือดเหมาะสำหรับฆ่าแทงค์"
    ),
    "Kimmy": (
        "มีความสามารถในการยิงกระสุนปืนกลในขณะที่เดินเคลื่อนที่ไปพร้อมกัน"
    ),
    ...
    "Gatotkaca": (
        "มีความสามารถในการกระโดดกระแทกจากฟ้าและเปลี่ยนเกราะรับดาเมจเป็นพลังโจมตี"
    ),
    "Guinevere": (
        "มีความสามารถในการกระโดดลอยตัวและสร้างคอมโบสกิลสตันกลางอากาศ"
    ),
    "Jawhead": (
        "มีความสามารถในการโยนเป้าหมายเข้าหาเพื่อนหรือปาออกไปเพื่อเปิดจังหวะ"
    ),
    "Julian": (
        "มีความสามารถในการผสมผสานสกิลทั้ง 3 เพื่อเลือกใช้ท่าที่เหมาะสมกับสถานการณ์"
    ),
    "Khaleed": "มีความสามารถในการพุ่งเข้าใส่และนั่งฟื้นฟูเลือดต้านดาเมจ",
    "Lapu-Lapu": (
        "มีความสามารถในการเปลี่ยนร่างเป็นดาบคู่เพื่อรับดาเมจและโจมตีหมู่รุนแรง"
    ),
    "Martis": (
        "มีความสามารถในการฟันกวาดและใช้อัลติเมทฟันซ้ำได้หากสังหารสำเร็จ"
    ),
    "Paquito": (
        "มีความสามารถในการสะสมสแตกต่อยคอมโบสกิลรัวๆ อย่างรวดเร็ว"
    ),
    ...
    "Sora": (
        "มีความสามารถในการสร้างดาเมจและเคลื่อนที่เข้าประชิดตัวเป้าหมายได้อย่างคล่องตัว"
    ),
    "Terizla": (
        "มีความสามารถในการทุบทำลายวงกว้างและดึงศัตรูด้วยโซ่มหาภัย"
    ),
    "Thamuz": "มีความสามารถในการเผาไหม้รอบตัวและโจมตีระยะประชิดด้วยความดุดัน",
    "Uranus": (
        "มีความสามารถในการฟื้นฟูเลือดตัวเองอย่างต่อเนื่องและเคลื่อนที่ไว"
    ),
    "X.Borg": (
        "มีความสามารถในการพ่นไฟระยะประชิดและเกราะนอกที่ช่วยป้องกันความตาย"
    ),
    ...
    "Cecilion": (
        "มีความสามารถในการปล่อยกระสุนเวทระยะไกลยิ่งยาวยิ่งสะสมมานาแรง"
    ),
    "Chang'e": (
        "มีความสามารถในการยิงกระสุนดาวกระจายเวทใส่ศัตรูอย่างรวดเร็ว"
    ),
    ...
    "Luo Yi": (
        "มีความสามารถในการสลับขั้วหยิน-หยางเพื่อดึงศัตรูกระแทกกันและเทเลพอร์ตทีม"
    ),
    "Lylia": (
        "มีความสามารถในการวางระเบิดลูกบอลจิ๋วและย้อนเวลากลับไปฟื้นฟูเลือด"
    ),
    "Nana": (
        "มีความสามารถในการแปลงร่างศัตรูให้เป็นแมวเหมียวและคืนชีพหนีตาย"
    ),
    "Novaria": (
        "มีความสามารถในการเปิดเผยวิสัยทัศน์ทั่วแผนที่และยิงกระสุนสไนเปอร์ระยะไกล"
    ),
    "Odette": "มีความสามารถในการร่ายเพลงมาร่วมสร้างคลื่นเสียงดาเมจวงกว้าง",
    "Pharsa": (
        "มีความสามารถในการแปลงร่างเป็นนกบินหนีและยิงปืนใหญ่เวทจากระยะไกล"
    ),
    ...
    "Valir": (
        "มีความสามารถในการสาดเปลวไฟผลักศัตรูออกไปและล้างสถานะควบคุม"
    ),
    ...
    "Grock": (
        "มีความสามารถในการสร้างกำแพงหินขวางทางและเพิ่มเกราะเมื่ออยู่ใกล้กำแพง"
    ),
    ...
    "Johnson": (
        "มีความสามารถในการแปลงร่างเป็นรถยนต์พุ่งชนพร้อมพาเพื่อนร่วมทีมขับซิ่ง"
    ),
    "Kaja": "มีความสามารถในการใช้แส้ลากกระชากศัตรูออกมาจากแนวหลัง",
    "Kalea": "มีความสามารถในการสนับสนุนเพื่อนและป่วนไฟต์ด้วยสกิลควบคุม",
    "Minotaur": (
        "มีความสามารถในการกระโดดทุบพื้นโกรธเกรี้ยวเพื่อสตันหมู่และฮีลเลือด"
    ),
    "Rafaela": (
        "มีความสามารถในการเร่งความเร็วเคลื่อนที่และฮีลเลือดให้ทีมพร้อมสโลว์ศัตรู"
    ),
    ...
    "Yi Sun-shin": (
        "มีความสามารถในการยิงธนูและฟันดาบสลับระยะ พร้อมใช้เรือเปิดแมพ"
    ),
    "Hanzo": (
        "มีความสามารถในการปลดร่างเงาปีศาจออกไปฟาร์มและโจมตีแนวหลังจากระยะไกลได้อย่างปลอดภัย"
    ),
    "Nolan": (
        "มีความสามารถในการสร้างรอยแยกมิติเพื่อสะสมดาเมจเบิสต์และเคลื่อนที่พุ่งทะลวงได้อย่างรวดเร็วต่อเนื่อง"
    ),
    "Ling": (
        "มีความสามารถในการไต่กำแพงด้วยความคล่องตัวสูง พุ่งโจมตีศัตรูจากมุมอับ"
        " และสร้างดาเมจเบิสต์รุนแรง"
    ),
    "Roger": (
        "มีความสามารถในการแปลงร่างเป็นมนุษย์และหมาป่าเพื่อไล่ล่าศัตรู"
        " สร้างดาเมจกายภาพรุนแรง และมีความคล่องตัวสูง"
    ),
    "Natalia": (
        "มีความสามารถในการล่องหนเข้าหาศัตรูจากมุมมืด"
        " ลอบสังหารเป้าหมายแนวหลังได้อย่างรวดเร็ว และสร้างความกดดันให้แผนที่"
    ),
    "Dyrroth": (
        "มีความสามารถในการลดเกราะของศัตรูอย่างรุนแรง"
        " สร้างดาเมจกายภาพเบิสต์ที่รุนแรง"
        " และดูดเลือดเพื่อต่อสู้ตัวต่อตัวได้อย่างยอดเยี่ยม"
    ),
    "Floryn": (
        "มีความสามารถในการมอบผลไม้มหัศจรรย์ช่วยเพิ่มช่องไอเทมให้เพื่อนร่วมทีม"
        " และฮีลฟื้นฟูพลังชีวิตให้เพื่อนร่วมทีมได้ทั่วทั้งแผนที่พร้อมสร้างความเสียหายใส่ศัตรู"
    ),
    "Fredrinn": (
        "มีความสามารถในการดูดซับความเสียหายเพื่อแปลงเป็นพลังงานสะสมมาใช้ปลดปล่อยอัลติเมททุบทำลายล้างเบิสต์ดาเมจได้อย่างรุนแรง"
        " และมีความอึดสูงในแนวหน้า"
    ),
    "Claude": (
        "มีความสามารถในการสะสมสแตกโจมตีความเร็วสูงด้วยการปล่อยลิงโขก"
        " สลับตำแหน่งพริ้วไหวหลอกศัตรูด้วยสกิล 2"
        " และใช้อัลติเมทพ่นกระสุนทำดาเมจหมู่พร้อมสร้างโล่คุ้มกันตัว"
    ),
    "Hirara": (
        "มีความสามารถในการพุ่งเข้าโจมตีอย่างรวดเร็วและสร้างความเสียหายรุนแรงเพื่อกดดันศัตรูในระยะประชิด"
    ),
    "Argus": (
        "มีความสามารถในการใช้อัลติเมทอมตะชั่วขณะเพื่อแปลงความเสียหายที่ได้รับให้กลับมาเป็นพลังชีวิต"
        " พร้อมโจมตีด้วยความเร็วสูงและรุนแรงในช่วงท้ายเกม"
    ),
    "Baxia": (
        "มีความสามารถในการแปลงร่างเป็นโล่กลิ้งเคลื่อนที่ได้อย่างรวดเร็วเพื่อเปิดไฟต์หรือไล่ล่า"
        " พร้อมทั้งมีสกิลติดตัวลดการฟื้นฟูพลังชีวิตและการดูดเลือดของศัตรู"
    ),
    "Cici": (
        "มีความสามารถในการกระโดดเด้งไปมาอย่างคล่องตัว"
        " ปาโยโย่โจมตีต่อเนื่องพร้อมเคลื่อนที่"
        " และล็อกเป้าหมายศัตรูเพื่อทำดาเมจพร้อมสโลว์อย่างมีประสิทธิภาพ"
    ),
}
...
if st.session_state.show_lobby_tier or show_tier_sidebar:
  ...
  for idx, hero in enumerate(popularTierList):
    ...
    with st.container():
      st.markdown(
          f"**🔥 อันดับที่ {rank}. {hero['name']} ({hero['th_name']})**"
      )
...
cols_chip = st.columns(min(len(st.session_state.recent_searches), 6))
for i, hero_name in enumerate(st.session_state.recent_searches):
  with cols_chip[i % len(cols_chip)]:
    if st.button(f"⭐ {hero_name}", key=f"chip_{i}"):
      if "enemy_input" in st.session_state:
        val = st.session_state.enemy_input.strip()
        if val and not val.endswith(","):
          st.session_state.enemy_input = val + ", " + hero_name + ", "
        elif val:
          st.session_state.enemy_input = val + " " + hero_name + ", "
        else:
...
if user_input.strip():
  ...
  if current_term:
    ...
    for th in all_thai_names:
      eng = thai_to_eng[th]
      if (
          current_term.lower() in th.lower()
          or current_term.lower() in eng.lower()
      ):
    ...
    for enemy in enemies:
      ...
      if not found_key:
        ...
        if best_match and highest_score >= 0.4:
          st.toast(
              f"ℹ️ ระบบปรับคำว่า '{enemy}' เป็น '{best_match}'"
              " ให้โดยอัตโนมัติ"
          )
          ...
          has_unknown = True
          st.toast(f"⚠️ ไม่พบข้อมูลของฮีโร่: {enemy}")
        ...
        with tabs[list(lane_map.keys()).index(tab_name)]:
          ...
          if not heroes_arr:
            ...
            for idx, (hero_name, data) in enumerate(heroes_arr):
              ...
              if rank == 1:
                st.success(
                    f"⭐ **{rank}. {hero_name} ({data['th_name']}) - 🔥"
                    " แนะนำสุดๆ! 🔥**"
                )
                st.write(
                    f"💡 **เหตุผล:** {reasons_str} | **{score_label}:** {score}"
                )
